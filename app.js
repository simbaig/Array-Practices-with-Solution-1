...
const fifteen = inventors.filter((n) => n.year >= 1500 && n.year < 1600);
...
const birtDate = inventors.sort((a, b) => (a.year > b.year ? 1 : -1)); // TERNARY OPERATOR
...
const Names = people.sort((previous, next) => {
